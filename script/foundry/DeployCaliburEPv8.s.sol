...
import { CaliburEntry } from "src/CaliburEPv8/CaliburEntry.sol";
import { Script, console2 as console } from "lib/forge-std/src/Script.sol";

contract DeployCaliburEPv8 is Script {
    bytes32 constant salt = 0x00000000000000000000000000000000000000000000000000000000051b023e;
