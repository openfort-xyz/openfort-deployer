...
import { EntryPointSimulations } from "lib/account-abstraction-v9/contracts/core/EntryPointSimulations.sol";
import { Script, console2 as console } from "lib/forge-std/src/Script.sol";

contract DeployEntryPointSimulations is Script {
    bytes32 constant salt = 0x00000000000000000000000000000000000000000000000000000000749019f8;
    ...
    function run() public {
        ...
        bytes memory creationCode = abi.encodePacked(type(EntryPointSimulations).creationCode);
