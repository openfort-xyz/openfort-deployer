...
pragma solidity =0.8.19 ^0.8.0 ^0.8.1 ^0.8.12 ^0.8.2 ^0.8.8;
...
// contracts/UpgradeableOpenfortAccount3/contracts/interfaces/OpenfortErrorsAndEvents.sol
...
// contracts/UpgradeableOpenfortAccount3/contracts/core/base/TokenCallbackHandler.sol
...
// contracts/UpgradeableOpenfortAccount3/contracts/core/base/BaseOpenfortAccount.sol
    ...
    OpenfortErrorsAndEvents
{
        ...
        returns (uint256 validationData)
    {
        ...
        if (isValidSessionKey(signer, userOp.callData)) {
            return _packValidationData_1(false, sessionKeys[signer].validUntil, sessionKeys[signer].validAfter);
        }
...
// contracts/UpgradeableOpenfortAccount3/contracts/core/base/BaseRecoverableAccount.sol
...
// contracts/UpgradeableOpenfortAccount3/contracts/core/upgradeable/UpgradeableOpenfortAccount.sol
