...
pragma solidity =0.8.19 ^0.8.0 ^0.8.1 ^0.8.12 ^0.8.19;
...
// contracts/OpenfortPaymasterV2/contracts/interfaces/OpenfortErrorsAndEvents.sol
...
// contracts/OpenfortPaymasterV2/contracts/interfaces/IBaseOpenfortPaymaster.sol
...
// contracts/OpenfortPaymasterV2/contracts/paymaster/BaseOpenfortPaymaster.sol
...
// contracts/OpenfortPaymasterV2/contracts/paymaster/OpenfortPaymasterV2.sol
...
contract OpenfortPaymasterV2 is BaseOpenfortPaymaster {
        ...
        returns (bytes memory context, uint256 validationData)
    {
        ...
        if (owner() != ECDSA.recover(hash, signature)) {
            return ("", _packValidationData_1(true, validUntil, validAfter));
        }
        ...
        return (context, _packValidationData_1(false, validUntil, validAfter));
    }
