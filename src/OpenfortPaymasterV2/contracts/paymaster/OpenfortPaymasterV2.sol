...
import {UserOperation, UserOperationLib, IEntryPoint} from "lib/account-abstraction/contracts/core/BaseAccount.sol";
...
constructor(IEntryPoint _entryPoint, address _owner) BaseOpenfortPaymaster(_entryPoint, _owner) {
        ...
        returns (bytes memory context, uint256 validationData)
    {
        ...
        bytes32 hash = MessageHashUtils.toEthSignedMessageHash(getHash(userOp, validUntil, validAfter, strategy));
