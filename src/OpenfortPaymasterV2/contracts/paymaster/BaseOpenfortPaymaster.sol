...
import {IEntryPoint, UserOperation, UserOperationLib} from "lib/account-abstraction/contracts/interfaces/IEntryPoint.sol";
...
abstract contract BaseOpenfortPaymaster is IBaseOpenfortPaymaster, Ownable2Step {
    ...
    constructor(IEntryPoint _entryPoint, address _owner) Ownable2Step(_owner) {
