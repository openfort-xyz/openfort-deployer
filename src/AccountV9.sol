...
contract MinimalAccountV9 {
    ...
    function getRecoveryPeriod() external view returns (uint256) {
        return recoveryPeriod;
    }

    function getSecurityPeriod() external view returns (uint256) {
    ...
    function getInitialGuardian() external view returns (address) {
